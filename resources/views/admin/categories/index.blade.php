        ...
        <tbody>
            @foreach($categories as $category)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('categories.edit', $category->id) }}" class="class btn btn-warning">
                        ...
                        <a href="{{ route('categories.destroy', $category->id) }}" onclick="return confirm('¿Desea eliminar este regitro?')" class="class btn btn-danger">
