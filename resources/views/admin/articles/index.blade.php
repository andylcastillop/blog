...
@section('content')
    <a href="{{ route('articles.create') }}" class="btn btn-info  pull-left">Registrar nuevo artículo</a>
    {!! Form::open(['route' => 'articles.store', 'method' => 'GET', 'class' => 'navbar-form pull-right']) !!}
        ...
        <tbody>
            @foreach($articles as $article)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('articles.edit', $article->id) }}" class="class btn btn-warning">
                        ...
                        <a href="{{ route('articles.destroy', $article->id) }}" onclick="return confirm('¿Desea eliminar este regitro?')" class="class btn btn-danger">
