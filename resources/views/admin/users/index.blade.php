        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('users.edit', $user->id) }}" class="class btn btn-warning">
                        ...
                        <a href="{{ route('users.destroy', $user->id) }}" onclick="return confirm('¿Desea eliminar este regitro?')" class="class btn btn-danger">
